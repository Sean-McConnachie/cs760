...
def import_custom_nodes() -> None:
    ...
    # init_extra_nodes needs to be run as async
...
def run_inpainting_wan_1_3(
    ...
    with torch.inference_mode():
        ...
        modelsamplingsd3_48 = modelsamplingsd3.patch(
            shift=5, model=get_value_at_index(loraloader_227, 0)
        )
